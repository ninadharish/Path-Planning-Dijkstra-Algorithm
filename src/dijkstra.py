...
def userInput():
    ...
    initial_x = int(input("Enter x xoordinate of starting point: "))
    initial_y = int(input("Enter y xoordinate of starting point: "))

    goal_x = int(input("Enter x xoordinate of goal point: "))
    goal_y = int(input("Enter y xoordinate of goal point: "))
